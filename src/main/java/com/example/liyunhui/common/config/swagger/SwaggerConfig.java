...
public class SwaggerConfig {
    ...
    public Docket docket(){
    	...
    	for (HandlerNoSuccess httpCode : HandlerNoSuccess.values()) {
    		responseMessageList.add(new ResponseMessageBuilder().code(httpCode.getCode()).message(httpCode.getMessage()).build());
		}
...
//                   当前包路径
                   .apis(RequestHandlerSelectors.basePackage("com.example.liyunhui.controller"))
